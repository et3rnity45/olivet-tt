...
import tableauxSamedi from '@/assets/background/tableaux-samedi.png';
import tableauxDimanche from '@/assets/background/tableaux-dimanche.png';
		...
		<section className='mx-4 py-16' id='brackets'>
			<div className='container mx-auto max-w-screen-lg'>
				...
				<div className='flex flex-wrap space-y-16'>
					...
					<img className='h-auto w-full rounded' src={tableauxSamedi} alt='Inscriptions en ligne' />
					<img
						className='h-auto w-full rounded'
						src={tableauxDimanche}
