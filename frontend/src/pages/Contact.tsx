    ...
    <section className="py-8 lg:py-16 mx-4" id="contact">
      <div className="container mx-auto">
        ...
        <div className="flex flex-col lg:flex-row">
          <div className="w-full lg:w-2/3 aspect-w-16 aspect-h-9 lg:aspect-w-5 lg:aspect-h-2 mb-12 lg:mr-12">
            <iframe
          ...
          <div className="w-full lg:w-1/3">
            <h3 className="text-lg font-medium mb-5">La Salle</h3>
            ...
            <h3 className="text-lg font-medium mb-5 mt-10">Les Entraîneurs</h3>
            <div className="font-light">
              {trainers.map((trainer) => (
                <p key={trainer.name}>{trainer.name}</p>
              ))}
            </div>
            <h3 className="text-lg font-medium mb-5 mt-10">Contact</h3>
            <div className="font-light">
              <div>
                <MailIcon height="20" className="inline-block text-gray mr-2" />
                <a
              ...
              <div>
                <PhoneIcon
                  height="20"
                  className="inline-block text-gray mr-2"
                />
                <span>{coordinates.phone}</span>
              </div>
            </div>
            <h3 className="text-lg font-medium mb-5 mt-10">Réseaux Sociaux</h3>
            <ul className="flex">
              <li className="mr-3">
                <a href={coordinates.facebook} target="_blank" rel="noreferrer">
                  <Facebook
                    height="24"
                    width="24"
                    className="text-gray hover:text-lightRed"
                  />
                </a>
              </li>
              <li className="mr-3">
